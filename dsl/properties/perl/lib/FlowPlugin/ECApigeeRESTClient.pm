...
package FlowPlugin::ECApigeeRESTClient;
use strict;
use warnings;
use LWP::UserAgent;
use JSON;
...
use FlowPDF::Log;
## DO NOT EDIT THIS BLOCK === rest client imports ends, checksum: 505fa7a0feb93627b8afe7d52d0a352e ===
# Place for the custom user imports, e.g. use File::Spec
## DO NOT EDIT THIS BLOCK === rest client starts ===
=head1

FlowPlugin::ECApigeeRESTClient->new('http://endpoint', {
...
use constant {
    ...
    USER_AGENT => 'ECApigeeRESTClient REST Client',
...
Use this method to create a new FlowPlugin::ECApigeeRESTClient, e.g.

    my $client = FlowPlugin::ECApigeeRESTClient->new($endpoint,
...
# developer_email_or_id: in path

# app_name: in path

# consumer_key: in path
...
sub addApiProductToKey {
    ...
    $self->{method} = 'addApiProductToKey';
    $self->{methodParameters} = \%params;

    my $uri = "/organizations/{{org_name}}/developers/{{developer_email_or_id}}/apps/{{app_name}}/keys/{{consumer_key}}";
...
## DO NOT EDIT THIS BLOCK === rest client ends, checksum: 1f9a0f3c197039f0500387dd59b22036 ===
sub addApiProductToKey {
    my ($self, %params) = @_;
    ...
    my $payload = {
        ...
        'apiProducts' => decode_json($params{ 'apiProducts' }),

        'attributes' => decode_json($params{ 'attributes' }),
